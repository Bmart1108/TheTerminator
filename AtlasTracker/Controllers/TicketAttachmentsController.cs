...
namespace AtlasTracker.Controllers
{
    public class TicketAttachmentsController : Controller
    {
        ...
        {
            ViewData["TicketId"] = new SelectList(_context.Tickets, "Id", "OwnerUserId");
        ...
        public async Task<IActionResult> Create([Bind("Id,Description,Created,FileName,FileData,FileContentType,UserId,TicketId,TicketTaskId")] TicketAttachment ticketAttachment)
        {
            ...
            ViewData["TicketId"] = new SelectList(_context.Tickets, "Id", "OwnerUserId", ticketAttachment.TicketId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Description,Created,FileName,FileData,FileContentType,UserId,TicketId,TicketTaskId")] TicketAttachment ticketAttachment)
        {
